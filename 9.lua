...
Main.BackgroundColor3 = Color3.fromRGB(0, 128, 128)
...
elseif _G.WhiteScreen == false then
    ...
    PosY = 25
    Settings:AddSlider("Pos Y Distance Farm ",0,50,25,function(value)
    PosY = value
    end)
...
Visual:AddToggle("Remove Fog",RemoveFog,function(value)
    ...
    Visual:AddToggle("Remove Damage",true,function()
...
ImageButton1.Image = "http://www.roblox.com/asset/?id=17405106651"
