...
Set:Toggle("Super Fast Attack ( Test )", true, function(value)
    _G.Fast1 = value
end)
--Fast Attack Delta
...
task.spawn(function()
    ...
    RL.wrapAttackAnimationAsync = function(a,b,c,d,func)
        ...
        local Radius = _G.Fast1 or 65
        if _G.Fast1 and canHits and #canHits > 0 then
        ...
        pcall(function()
            if #canHits > 0 then
                ...
                if Controller and Controller.equipped and (not Char.Busy.Value or not LocalPlayer.PlayerGui.Main.Dialogue.Visible) and Char.Stun.Value == 0 and Controller.currentWeaponModel then
                    if _G.Fast1 then
                        if _G.Fast1 and tick() > AttackCD then
                            resetCD()
                        end 
...
local PolePos = CFrame.new(-7748.0185546875, 5606.80615234375, -2305.898681640625)
 ...
 spawn(function()
    ...
    M:Toggle("Auto Farm Ectoplasm",_G.AutoEctoplasm,function(V)
        _G.AutoEctoplasm = V
...
--------------------------------------------------------------------------------------------------------
    ...
    P:Toggle("Aimbot Skill Nearest",false,function(V)
    _G.AimNearest = V
end)
...
spawn(function()
	pcall(function()
		game:GetService("RunService").RenderStepped:connect(function()
			if _G.AimNearest and TargetPlayerAim ~= nil and game.Players.LocalPlayer.Character:FindFirstChildOfClass("Tool") and game.Players.LocalPlayer.Character[game.Players.LocalPlayer.Character:FindFirstChildOfClass("Tool").Name]:FindFirstChild("MousePos") then
				local args = {
