...
----------------------------------------------------------------------------------------------------------------------------------------
local ui_link = "https://raw.githubusercontent.com/NguyenLam2504/anhyeuem/main/AnCutGui.lua"
local Add = loadstring(game:HttpGet(ui_link))()
local Add = Add:Window("Free Version | Blox Fruit")
